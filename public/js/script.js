function gra(){
	document.getElementById("tekst").innerHTML = '<embed src="pdf/gra.pdf" width="100%" height="340"/>'
};

function autor(){
	document.getElementById('tekst').innerHTML = '<p>Agnieszka Rzeszuto 206323, 3 rok Informatyki UG</p>'
};
